<div align="center">
  ...
  <h3 align="center">Pragati Resume Analyzer</h3>

   <div align="center">
     Owner: <b>Pragati Pandey</b>
    </div>
</div>
...
This repository is maintained as a personal project by <b>Pragati Pandey</b>.
...
If you're getting started and need assistance, open an issue in this repository.
...
```bash
git clone https://github.com/pragati-pandey/pragati-resume-analyzer.git
cd pragati-resume-analyzer
```
...
Assets and static files used in this project are available in the repository under `public/`.

## <a name="more">🚀 More</a>

Planned improvements:

- Better role-specific scoring templates.
- Improved resume parsing quality for diverse formats.
- Expanded feedback insights for interview readiness.
